...
% PDF metadata
\hypersetup{pdftitle={Project Report Group 2 Experts in team},
...
\include{Main_body/the_project}
\include{Main_body/further_work}
\include{Main_body/socialbenefits}
\include{Main_body/conclusion}
